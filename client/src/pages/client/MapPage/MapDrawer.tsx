...
export default function MapDrawer({ toggleDrawer, data }: any) {
  return (
      ...
      >
        ...
        <Box sx={{ marginTop: 2, display: "flex", flexDirection: "column" }}>
          ...
          <Typography variant="body2" gutterBottom>
            ...
            voluptates odio corrupti perferendis ipsa deleniti eum provident
            dolore, molestias quaerat, soluta odit. Vel suscipit tempore enim?
            Nesciunt ex voluptate dolor!
          </Typography>
        </Box>
      </Box>
    </Box>
